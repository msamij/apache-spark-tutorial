...
public class MultilineJsonToDataframeWithCorruptRecordApp {
  ...
  public static void main(String[] args) {
    MultilineJsonToDataframeWithCorruptRecordApp app = new MultilineJsonToDataframeWithCorruptRecordApp();
    app.start();
  }
  ...
  private void start() {
    ...
    Dataset<Row> df = spark.read().format("json").load("data/countrytravelinfo.json");
